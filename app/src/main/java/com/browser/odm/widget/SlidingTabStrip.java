...
package com.browser.odm.widget;
...
class SlidingTabStrip extends LinearLayout {
    ...
    private static int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFFFFFFFF;
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        t = ThemeController.getInstance().getCurrentTheme();
        DEFAULT_SELECTED_INDICATOR_COLOR = t.barItemColor;
